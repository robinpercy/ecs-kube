...
var ecsdeploymentsResource = schema.GroupVersionResource{Group: "ecskube.ecskube", Version: "", Resource: "ecsdeployments"}

var ecsdeploymentsKind = schema.GroupVersionKind{Group: "ecskube.ecskube", Version: "", Kind: "ECSDeployment"}

// Get takes name of the eCSDeployment, and returns the corresponding eCSDeployment object, and an error if there is any.
func (c *FakeECSDeployments) Get(name string, options v1.GetOptions) (result *ecskube.ECSDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ecsdeploymentsResource, c.ns, name), &ecskube.ECSDeployment{})

	if obj == nil {
		return nil, err
	}
	return obj.(*ecskube.ECSDeployment), err
}
...
func (c *FakeECSDeployments) Create(eCSDeployment *ecskube.ECSDeployment) (result *ecskube.ECSDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ecsdeploymentsResource, c.ns, eCSDeployment), &ecskube.ECSDeployment{})
...
func (c *FakeECSDeployments) Update(eCSDeployment *ecskube.ECSDeployment) (result *ecskube.ECSDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ecsdeploymentsResource, c.ns, eCSDeployment), &ecskube.ECSDeployment{})
...
func (c *FakeECSDeployments) UpdateStatus(eCSDeployment *ecskube.ECSDeployment) (*ecskube.ECSDeployment, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ecsdeploymentsResource, "status", c.ns, eCSDeployment), &ecskube.ECSDeployment{})
...
func (c *FakeECSDeployments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ecsdeploymentsResource, c.ns, name), &ecskube.ECSDeployment{})
...
func (c *FakeECSDeployments) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &ecskube.ECSDeploymentList{})
	return err
}

// Patch applies the patch and returns the patched eCSDeployment.
func (c *FakeECSDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *ecskube.ECSDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ecsdeploymentsResource, c.ns, name, data, subresources...), &ecskube.ECSDeployment{})
