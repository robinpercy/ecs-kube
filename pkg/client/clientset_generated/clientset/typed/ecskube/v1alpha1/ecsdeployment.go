...
import (
	...
	scheme "github.com/robinpercy/ecs-kube/pkg/client/clientset_generated/clientset/scheme"
...
type ECSDeploymentInterface interface {
	Create(*v1alpha1.ECSDeployment) (*v1alpha1.ECSDeployment, error)
	Update(*v1alpha1.ECSDeployment) (*v1alpha1.ECSDeployment, error)
	UpdateStatus(*v1alpha1.ECSDeployment) (*v1alpha1.ECSDeployment, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ECSDeployment, error)
	List(opts v1.ListOptions) (*v1alpha1.ECSDeploymentList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ECSDeployment, err error)
...
func newECSDeployments(c *EcskubeV1alpha1Client, namespace string) *eCSDeployments {
...
func (c *eCSDeployments) Get(name string, options v1.GetOptions) (result *v1alpha1.ECSDeployment, err error) {
	result = &v1alpha1.ECSDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *eCSDeployments) List(opts v1.ListOptions) (result *v1alpha1.ECSDeploymentList, err error) {
	result = &v1alpha1.ECSDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ecsdeployments").
...
func (c *eCSDeployments) Create(eCSDeployment *v1alpha1.ECSDeployment) (result *v1alpha1.ECSDeployment, err error) {
	result = &v1alpha1.ECSDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ecsdeployments").
...
func (c *eCSDeployments) Update(eCSDeployment *v1alpha1.ECSDeployment) (result *v1alpha1.ECSDeployment, err error) {
	result = &v1alpha1.ECSDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecsdeployments").
...
func (c *eCSDeployments) UpdateStatus(eCSDeployment *v1alpha1.ECSDeployment) (result *v1alpha1.ECSDeployment, err error) {
	result = &v1alpha1.ECSDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecsdeployments").
...
func (c *eCSDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ECSDeployment, err error) {
	result = &v1alpha1.ECSDeployment{}
