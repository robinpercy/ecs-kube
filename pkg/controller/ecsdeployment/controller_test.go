...
import (
	...
	. "github.com/robinpercy/ecs-kube/pkg/client/clientset_generated/clientset/typed/ecskube/v1alpha1"
...
var _ = Describe("ECSDeployment controller", func() {
	var instance ECSDeployment
	var expectedKey string
	var client ECSDeploymentInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = ECSDeployment{}
		instance.Name = "instance-1"
		expectedKey = "ecsdeployment-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.EcskubeV1alpha1().ECSDeployments("ecsdeployment-controller-test-handler")
